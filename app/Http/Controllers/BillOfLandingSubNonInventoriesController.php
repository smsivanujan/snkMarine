    ...
    public function showByFilter(Request $request)
    {
        ...
        $billoflandingsubnoninventories = DB::table('bill_of_landing_sub_non_inventories')
            ...
            if (!empty($request->bill_of_landing_id) && !empty($request->equipment_id) && !empty($request->client_id_agent) && !empty($request->vendor_id_yard)) {
                ...
                $billoflandingsubnoninventories = $billoflandingsubnoninventories
                    ->where('bill_of_landing_sub_non_inventories.bill_of_landing_id', '=', $request->bill_of_landing_id)
                    ->where('bill_of_landing_sub_non_inventories.equipment_id', '=', $request->equipment_id)
                    ->where('bill_of_landing_sub_non_inventories.client_id_agent', '=', $request->client_id_agent)
                    ->where('bill_of_landing_sub_non_inventories.vendor_id_yard', '=', $request->vendor_id_yard);
                ...
                $billoflandingsubnoninventories = $billoflandingsubnoninventories
                    ->where('bill_of_landing_sub_non_inventories.equipment_id', '=', $request->equipment_id);
            } elseif (empty($request->bill_of_landing_id) && empty($request->bill_of_landing_id) && !empty($request->client_id_agent) && !empty($request->vendor_id_yard)) {
        ...
        $result = $billoflandingsubnoninventories->orderBy('bill_of_landing_sub_non_inventories.id')
            ->get();
        return $result;
    }
