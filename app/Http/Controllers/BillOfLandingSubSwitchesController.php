...
class billoflandingswitchSubSwitchesController extends Controller
{
    public function index()
    {
        $billoflandingsubswitches = DB::table('bill_of_landing_sub_switches')
            ->select(
                ...
                'bill_of_landing_sub_switches.date',
            ...
            ->join('bill_confirmations', 'bill_of_landing_sub_switches.bill_confirmation_id', '=', 'bill_confirmations.id')
            ...
            ->join('vendor_id_yard', 'bill_of_landing_sub_switches.bill_confirmation_id', '=', 'vendors.id')
            ->get();
