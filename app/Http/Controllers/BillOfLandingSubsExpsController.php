...
class BillOfLandingSubsExpsController extends Controller
{
    public function index()
    {
        $billoflandingsubnoninventoriesexps = DB::table('bill_of_landing_subs_exps')
            ->select(
                ...
                'bill_of_landing_subs_exps.blsn_invent_id',
            ...
            ->join('bill_of_landing_sub_non_inventories', 'bill_of_landing_subs_exps.blsn_invent_id', '=', 'bill_of_landing_subs_exps.id')
    ...
    public function store(Request $request)
    {
        ...
        try {
            $billoflandingsubsexps->blsn_invent_id = $request->blsn_invent_id;
